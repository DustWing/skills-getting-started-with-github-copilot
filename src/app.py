...
activities = {
    ...
    "Tennis Club": {
        ...
        "max_participants": 20,
        "participants": ["jacob@mergington.edu", "sarah@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Science Olympiad": {
        "description": "Compete in science events and build experimental projects",
...
def signup_for_activity(activity_name: str, req: EmailRequest):
